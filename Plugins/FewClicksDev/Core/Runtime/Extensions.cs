namespace FewClicksDev.Core
{
    ...
    public static class Extensions
    {
        ...
        public static T GetOrAddComponent<T>(this Component _component) where T : Component
        {
            if (_component == null)
            {
                return null;
            ...
            return _component.gameObject.GetOrAddComponent<T>(out _);
        }
        ...
        public static T GetOrAddComponent<T>(this GameObject _gameObject) where T : Component
        {
            ...
            return _gameObject.GetOrAddComponent<T>(out _);
        }
