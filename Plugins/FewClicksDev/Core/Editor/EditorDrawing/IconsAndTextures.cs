namespace FewClicksDev.Core
{
    ...
    {
        private const string FEW_CLICKS_DEV_ICON_FOLDER = "Assets/Plugins/FewClicksDev";
        ...
        private static Texture2D findAndReturnIcon(ref Texture2D _icon, string _textureName)
        {
            if (_icon == null)
            {
                _icon = AssetsUtilities.GetAssetOfType<Texture2D>(_textureName, FEW_CLICKS_DEV_ICON_FOLDER);
            }
